            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="container mx-auto p-8">
                        <h1 class="text-2xl font-bold">รายชื่อผู้ติดต่อ</h1>

                        <div class="overflow-x-auto">
                            <table class="table-auto w-full border-collapse border border-grey-300">
                                <thead>
                                    <tr class="bg-grey-100">
                                        <th class="border border-gray-300 px-4 py-2 text-left w-12">ลำดับ</th>
                                        <th class="border border-gray-300 px-4 py-2 text-left">รายชื่อ</th>
                                        <th class="border border-gray-300 px-4 py-2 text-left">Email</th>
                                        <th class="border border-gray-300 px-4 py-2 text-left w-32">แชท</th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border border-gray-300 px-4 py-2 relative">
                                                    <a navigate href="{{ route('chat', $user->id) }}">
                                                        ...
                                                        <span class="{{ $user->unread_messages_count > 0 ? 'absolute
                                                        right-11 top-2 bg-red-600 text-white px-2 py-1 rounded-full text-xs font-bold' : '' }}">
